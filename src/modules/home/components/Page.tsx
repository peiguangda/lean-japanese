...
import {BackTop, Layout, Icon, Select, Checkbox} from "antd";
                        ...
                        <div className="display-flex filter-panel">
                            ...
                            <div className="select-form ">
                                <label>Loại hình</label>
                                    <Select defaultValue="Khóa học online" style={{ width: 120 }} onChange={handleChange}>
                            ...
                            <div className="select-form">
                                <label>Sắp xếp</label>
                                <Select defaultValue="Chọn sắp xếp" style={{ width: 120 }} onChange={handleChange}>
